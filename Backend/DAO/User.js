...
export const signUpDao = async (res,userName , email , password)=>{
    try {
        ...
        if(isExist && isExist.isVerified == false){
            userModel.findByIdAndDelete(isExist._id)
        ...
        const createdUser = await userModel.create({
            userName,email,password,verifiedToken:verificationCode,verificationExpireTime
        })
        ...
        return badResponse(res,400,"Error ocuured in Data Access")
    }
}
